...
#define NRF_LOG_MODULE_NAME "ADPS"
#include "nrf_log.h"
...
/* APDS-9960 I2C 7bit address */
#define APDS9960_I2C_ADDR       0x39

APDS9960* APDS9960::pAPDS9960 = 0;
...
int APDS9960::readGesture() {
	...
	if (1) {
		...
		if (!(getMode() & 0b01000001)) {
			NRF_LOG_ERROR("ADPS internal error\r\n");
			return DIR_NONE;
		}
...
bool APDS9960::processGestureData() {
	...
	if (gesture_data_.total_gestures <= 4) {
		NRF_LOG_INFO("Not enought total gestures\r\n");
		return false;
	}
...
bool APDS9960::wireWriteDataByte(uint8_t reg, uint8_t val) {
	return i2c_write_reg_8(APDS9960_I2C_ADDR, reg, val);
}
...
//	if (!i2c_write8(APDS9960_I2C_ADDR, reg)) {
//		//return false;
//	}

	return i2c_read_reg_8(APDS9960_I2C_ADDR, reg, &val);
}
...
//	}
	...
	if (!i2c_read_reg_n(APDS9960_I2C_ADDR, reg, val, len)) {
		NRF_LOG_ERROR("Error reading bytes at 0x%X", reg)
		return 0;
	}
