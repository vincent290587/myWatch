...
#ifndef LIBRARIES_ADPS9960_H_
#define LIBRARIES_ADPS9960_H_
...
#define DEFAULT_GCONF1          0xC0    // 4 gesture events for int., 1 for exit
...
enum {
	DIR_NONE, DIR_LEFT, DIR_RIGHT, DIR_UP, DIR_DOWN, DIR_NEAR, DIR_FAR, DIR_ALL, DIR_PROGRESS
};
...
public:
	...
	volatile boolean gestureISRFlag;
	static APDS9960* pAPDS9960;
